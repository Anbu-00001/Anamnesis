...
- **OpenAI Sept 2025 (via code-calibration lit, arXiv 2605.12201).** Next-token training + accuracy benchmarks reward confident guessing → models are *structurally* trained toward overconfidence. An external calibration instrument is the counter-pressure.
